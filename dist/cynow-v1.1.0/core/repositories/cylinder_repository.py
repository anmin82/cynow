...
class CylinderRepository:
    ...
    @staticmethod
    def get_cylinder_list(filters: Optional[Dict] = None, limit: Optional[int] = None, offset: Optional[int] = None, days: Optional[int] = None) -> List[Dict]:
        """
        개별 용기 리스트
